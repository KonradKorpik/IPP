            	...
            	<div class="row" style="align-items: center;">
                	...
                	<div class="col-9" style="padding: 0;">
                    	<ul class="" style="margin: 0; padding: 0; display: flex; align-items: center; position: relative; list-style-type: none;">
							...
							<a class="" style="" href="<?php echo get_site_url(); ?>/samochody/">
								<li id="sub-menu-container-1" class="" style="position: relative;">
									...
									<div id="sub-menu-content-1" class="sub-menu-1" style="position: absolute; top: 100%; left: 0; background-color: #333333;">
										<ul class="" style="margin: 0; padding: 0; display: flex; flex-direction: column; align-items: center; list-style-type: none;">
											<a href="<?php echo get_site_url(); ?>/mclaren/">
												<li class="" style="">
													McLaren
												</li>
											</a>
											<a href="<?php echo get_site_url(); ?>/porshe/">
												<li class="" style="">
													Porshe
												</li>
											</a>
											<a href="<?php echo get_site_url(); ?>/bmw/">
												<li class="" style="">
													BMW
												</li>
											</a>
							...
							<a class="" style="" href="<?php echo get_site_url(); ?>/kariera/">
								<li class="" style="">
                            		Kariera
                        		</li>
							</a>
							<a class="" style="position: absolute; right: 0;" href="<?php echo get_site_url(); ?>/kontakt/">
								<li class="" style="">
                            		Kontakt
                        		</li>
							</a>
        	...
        	<div class="row" style="">
            	...
            	<div id="content" class="" style="margin: 2rem 0 0 0; padding: 1rem 0; background-color: #ffffff; display: none;">
                	<ul class="" style="margin: 0; padding: 0 0 0 12px; list-style-type: none;">
                    	<li class="" style="">
                        	<div class="row" style="">
                            	<div class="col-8" style="">
                                	<a class="" style="color: #000000; font-size: 1.25rem; font-weight: 600; text-decoration: none;" href="<?php echo get_site_url(); ?>/samochody/">
                                    	Samochody
                                	</a>
                            	</div>
							...
							<div id="sub-0" class="sub-menu-10" style="display: none;">
								<ul class="" style="padding: 0 0 0 1rem; list-style-type: none;">
									<li class="" style="">
										<a class="" style="color: #000000; font-weight: 600; text-decoration: none;" href="<?php echo get_site_url(); ?>/mclaren/">
											McLaren
										</a>
									</li>
									<li class="" style="">
										<a class="" style="color: #000000; font-weight: 600; text-decoration: none;" href="<?php echo get_site_url(); ?>/porshe/">
											Porshe
										</a>
									</li>
									<li class="" style="">
										<a class="" style="color: #000000; font-weight: 600; text-decoration: none;" href="<?php echo get_site_url(); ?>/bmw/">
											BMW
										</a>
									</li>
								</ul>
						...
						<li class="" style="">
							<a class="" style="color: #000000; font-size: 1.25rem; font-weight: 600; text-decoration: none;" href="<?php echo get_site_url(); ?>/kariera/">
								Kariera
							</a>
						</li>
						<li class="" style="">
							<a style="color: #000000; font-size: 1.25rem; font-weight: 600; text-decoration: none;" href="<?php echo get_site_url(); ?>/kontakt/">
								Kontakt
							</a>
                    	</li>
                	</ul>
