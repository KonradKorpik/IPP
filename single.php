...
<main id="main" class="" style="margin: 0;">
	<?php if( have_rows('image-content') ): ?>
		<?php while( have_rows('image-content') ) : the_row(); ?>
			<?php $image = get_sub_field('image'); ?>
			<section class="ImageContentOS" style="margin: 4rem 0 0 0;">
	...
	<?php if( have_rows('slider-content') ): ?>
		<?php while( have_rows('slider-content') ) : the_row(); ?>
			...
			<section id="slider_content" class="slider-content-desktop" style="margin: 4rem 0 0 0;">
    			<div class="container" style="">
        			<div class="" style="position: relative;">
            			<div id="slider" class="col-6" style="margin: 2rem 0; position: absolute; overflow: hidden;">
                			...
                			<button onclick="prevSlide()" style="border: none; position: absolute; top: 50%; left: 1rem; background-color: transparent; color: #000000; line-height: 2.5rem; font-size: 2.5rem; font-weight: 600; transform: translateY(-50%);"><</button>
                			<button onclick="nextSlide()" style="border: none; position: absolute; top: 50%; right: 1rem; background-color: transparent; color: #000000; line-height: 2.5rem; font-size: 2.5rem; font-weight: 600; transform: translateY(-50%);">></button>
            			</div>
			...
			<section id="slider_content_2" class="slider-content-mobile" style="margin: 4rem 0 0 0; padding: 2rem 0; background-color: #f5f5f5;">
    			<div class="container" style="">
        			<div class="" style="position: relative;">
            			...
            			<div id="slider2" class="col-12" style="margin: 2rem 0; padding: 2rem 0 0 0; position: absolute; overflow: hidden;">
                			...
                			<button onclick="prevSlide2()" style="border: none; position: absolute; top: 50%; left: 1rem; background-color: transparent; color: #000000; line-height: 2.5rem; font-size: 2.5rem; font-weight: 600; transform: translateY(-50%);"><</button>
                			<button onclick="nextSlide2()" style="border: none; position: absolute; top: 50%; right: 1rem; background-color: transparent; color: #000000; line-height: 2.5rem; font-size: 2.5rem; font-weight: 600; transform: translateY(-50%);">></button>
            			</div>
        			</div>
    			</div>
			</section>
	...
	<?php if( have_rows('price_list') ): ?>
		<?php while( have_rows('price_list') ) : the_row(); ?>
			<section id="price-list" class="" style="margin: 4rem 0;">
				<div class="container" style="">
					<div class="row" style="">
						<div class="" style="">
							<h2 class="" style="margin: 0 0 1rem 0; text-align: center;">
								<?php the_sub_field('title'); ?>
							</h2>
						</div>
						<div class="col-12 col-md-6 border-r" style="display: flex; flex-direction: column; align-items: center;">
							<?php the_sub_field('price_list_without_deposit'); ?>
						</div>
						<div class="col-12 col-md-6" style="display: flex; flex-direction: column; align-items: center;">
							<?php the_sub_field('price_list_with_deposit'); ?>
						</div>
					</div>
				</div>
			</section>
...
<script>
	...
	document.getElementById("slider_content_2").style.margin = "2rem 0 calc(" + document.getElementById("slider2").offsetHeight + "px + 4rem) 0";
